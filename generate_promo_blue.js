...
async function run() {
  ...
  const templates = [
    ...
    `<html><head>${commonHead}</head><body>
      ...
      <div class="content">
        ...
        <h1 style="font-size:95px;">The <span class="highlight">God</span><br/>View.</h1>
    ...
    `<html><head>${commonHead}</head><body>
      ...
      <div class="content">
        <div class="badge" style="background:white; color:#1e3a8a;">🚀 HARD HAT SOLUTIONS</div>
  ...
  for (let i = 0; i < templates.length; i++) {
    ...
    await page.screenshot({ path: '../carousel_blue_' + (i + 1) + '.png' });
    console.log('Generated carousel_blue_' + (i + 1) + '.png');
  }
